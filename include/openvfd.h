...
enum openvfd_led_dot1 {
    OPENVFD_LED_DOT1_ALARM,
    OPENVFD_LED_DOT1_USB,
    OPENVFD_LED_DOT1_PLAY,
    OPENVFD_LED_DOT1_PAUSE,
    OPENVFD_LED_DOT1_SEC,
    OPENVFD_LED_DOT1_ETH,
    OPENVFD_LED_DOT1_WIFI,
    OPENVFD_LED_DOT1_MAX
};

enum openvfd_led_dot2 {
    OPENVFD_LED_DOT2_APPS,
    OPENVFD_LED_DOT2_SETUP,
    OPENVFD_LED_DOT2_USB,
    OPENVFD_LED_DOT2_CARD,
    OPENVFD_LED_DOT2_SEC,
    OPENVFD_LED_DOT2_HDMI,
    OPENVFD_LED_DOT2_CVBS,
    OPENVFD_LED_DOT2_MAX
};

enum openvfd_led_dot3 {
    OPENVFD_LED_DOT3_UNUSED1,
    OPENVFD_LED_DOT3_UNUSED2,
    OPENVFD_LED_DOT3_POWER,
    OPENVFD_LED_DOT3_LAN,
    OPENVFD_LED_DOT3_SEC,
    OPENVFD_LED_DOT3_WIFIHI,
    OPENVFD_LED_DOT3_WIFILO,
    OPENVFD_LED_DOT3_MAX
};

enum openvfd_led_dot4 {
    OPENVFD_LED_DOT4_BT,
    OPENVFD_LED_DOT4_ETH,
    OPENVFD_LED_DOT4_WIFI,
    OPENVFD_LED_DOT4_SPDIF,
    OPENVFD_LED_DOT4_SEC,
    OPENVFD_LED_DOT4_HDMI,
    OPENVFD_LED_DOT4_AV,
    OPENVFD_LED_DOT4_MAX
};

extern const uint8_t openvfd_led_dots[OPENVFD_LED_DOT_MAX];
